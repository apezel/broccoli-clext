...
function onError(error) {
    ...
    if (!errorDiv) {
        console.log("inserting error div");
        document.body.innerHTML += "<div id=\"hot-css-error-div\"></div>";
        errorDiv = document.getElementById("hot-css-error-div");
        
    }
    
    errorDiv.style.cssText = "position:fixed;z-index:9999;background-color:rgba(0, 0, 0, 0.5);color: white;whidth: 100%;height: 100%;";
